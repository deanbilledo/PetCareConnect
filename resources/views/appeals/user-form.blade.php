...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <h1 class="text-2xl font-bold mb-6 text-center">Appeal Report Against You</h1>
        ...
        <div class="mb-6 bg-amber-50 dark:bg-amber-900 p-4 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <p class="font-medium">USR-{{ $report->id }}</p>
                </div>
                <div>
                ...
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Reported By:</p>
        ...
        <form action="{{ route('user.report.appeal.submit', ['report' => $report->id]) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
