...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Shop Appeal Details</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <h2 class="text-xl font-semibold mb-4 text-blue-600">Shop Report Details</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
        ...
        <h2 class="text-xl font-semibold mb-4 text-blue-600">Shop Information</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <p class="text-gray-600">Shop Name: <span class="font-semibold">{{ $report->shop->name }}</span></p>
                <p class="text-gray-600">Shop Owner: <span class="font-semibold">{{ $report->shop->user->name }}</span></p>
                <p class="text-gray-600">Shop Email: <span class="font-semibold">{{ $report->shop->email }}</span></p>
                <p class="text-gray-600">Shop Phone: <span class="font-semibold">{{ $report->shop->phone ?? 'N/A' }}</span></p>
                <p class="text-gray-600">Shop Address: <span class="font-semibold">{{ $report->shop->address ?? 'N/A' }}</span></p>
            </div>
        </div>
    </div>
