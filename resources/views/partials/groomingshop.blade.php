<section class="my-6">
    <h2 class="text-2xl font-semibold mb-4">Grooming Shops</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
        @foreach($popularShops as $shop)
        @if($shop->type === 'grooming' && $shop->status === 'active')
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl">
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center mt-1">
                        ...
                        <span class="ml-1 text-gray-600">{{ number_format($shop->rating, 1) }}</span>
                    </div>
