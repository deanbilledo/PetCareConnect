@php
$veterinaryShops = \App\Models\Shop::veterinary()
...
<section class="my-8 px-4 max-w-7xl mx-auto">
    <h2 class="text-3xl font-bold text-gray-900 mb-6">Veterinary Shops</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="w-full col-span-3">
            <div class="text-center py-12 bg-gray-50 rounded-xl">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">No Veterinary Shops</h3>
                <p class="mt-1 text-sm text-gray-500">No veterinary shops available at the moment.</p>
            </div>
        </div>
        @endforelse
    </div>
