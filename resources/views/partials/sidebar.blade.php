<nav class="h-full bg-white border-r" x-data="{ currentFragment: window.location.hash }">
    ...
    <div class="py-4 space-y-1">
        ...
        <a href="{{ route('shop.reviews') }}" 
           class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->routeIs('shop.reviews') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
            <svg class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
