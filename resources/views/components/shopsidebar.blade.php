...
<body>
<nav class="h-screen w-64 bg-white border-r border-gray-200 flex flex-col fixed top-0 left-0 bottom-0">
    {{-- Logo Section --}}
        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('services') }}"
                   class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('services') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('billingandpayments') }}"
                   class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('billingandpayments') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('analytics') }}"
                   class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('analytics') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('account') }}"
                   class="flex items-center space-x-3 p-3 rounded-lg {{ request()->routeIs('account') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-blue-50 hover:text-blue-600' }} transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>
                    </svg>
                    <span>Account</span>
